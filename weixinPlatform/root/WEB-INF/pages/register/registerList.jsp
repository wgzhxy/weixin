...
<body>
	...
	<table id="dg" title="会员申请" class="easyui-datagrid"  idField="id"  
	...
	<div id="registerProccess"  class="easyui-dialog"  style="padding:10px 30px"  closed="true"   title="会员审核"  buttons="#dlg-buttons_edit" >
	...
	<div id="dlg-buttons_edit"  style="text-align:center;">
	    ...
	    <a href="#" style="padding-left: 20px;"  class="easyui-linkbutton"  iconCls="icon-cancel"  onclick="javascript:$('#registerProccess').dialog('close')">取消</a>
	</div>
<script type="text/javascript">
function optFormater(value,row,index){
	var opt = '<a href="#" onclick="workOrderProccess('+row.id+')">【审核处理】</a>';
	return opt;
};
//搜索功能
function doSearch() {
