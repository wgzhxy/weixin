       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'print', 'preview', 'searchreplace','help', 'insertimage' ]
        ]
        //当鼠标放在工具栏上时显示的tooltip提示,留空支持自动多语言配置，否则以配置值为准
        ,labelMap:{
            'anchor':'', 'undo':'', 'uploadimage':'上传图片', 'insertgood': '插入商品', 'qqemotion': '插入表情'
        }
        //webAppKey
        ...
        ,initialFrameWidth:358  //初始化编辑器宽度,默认1000
        ...
        ,initialStyle:'body{font-size:16px}'   //编辑器内部样式,可以用来改变字体等

        ,autoLink: true //自动加超链接
