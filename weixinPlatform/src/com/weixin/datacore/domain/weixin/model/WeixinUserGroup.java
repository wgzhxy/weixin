...
/**
 * WeixinUserGroup generated by hbm2java
 */
@Entity
@Table(name = "weixin_user_group")
public class WeixinUserGroup implements java.io.Serializable {
	...
	public WeixinUserGroup(String id) {
		this.id = id;
	}

	public WeixinUserGroup(String id, String groupId, String groupName,
