...
/**
 * WeixinPageClass generated by hbm2java
 */
@Entity
@Table(name = "weixin_page_class")
public class WeixinPageClass implements java.io.Serializable {
	...
	public WeixinPageClass() {
	}

	public WeixinPageClass(String id) {
		this.id = id;
	}

	public WeixinPageClass(String id, String className, String classDesc,
			String type, String operatorId, String operatorName,
